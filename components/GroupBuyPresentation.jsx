			...
			<div className="content">
				...
				<div className="right">
					<p className="section__text">
						...
						<strong>acheter</strong> par exemple une cigarette électronique sur le
						site Mia Vape en groupe. Il s&apos;agit d&apos;un très bon moyen pour
						casser les prix et profiter d&apos;un large réduction sur un article sous
						réserve que vous achetiez tous en même temps par groupe de 5 ou 10. Vous
						pouvez toutefois aussi profiter des{" "}
